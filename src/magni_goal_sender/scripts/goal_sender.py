...
class GoalSender:
    ...
    def __init__(self):
        ...
        #### parameters #######
        self.param_filename = rospy.get_param('~param_filename','/home/centaur/catkin_ws/src/magni_goal_sender/param/final_goals.yaml')  # where to find the goal list in yaml format
    ...
    def load_goals(self):
        content = ""
        with open('/home/centaur/catkin_ws/src/magni_goal_sender/param/final_goals.yaml', 'r') as content_file:
